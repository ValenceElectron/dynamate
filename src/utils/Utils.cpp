...
// PEARL material - ambient, diffuse, specular, and shininess from http://www.barradeau.com/nicoptere/dump/materials.html
float* Utils::pearlAmbient() { static float a[4] = { 0.25f, 0.20725f, 0.20725f, 0.922f }; return (float*)a; }
float* Utils::pearlDiffuse() { static float a[4] = { 1.0f, 0.829f, 0.829f, 0.922f }; return (float*)a; }
float* Utils::pearlSpecular() { static float a[4] = { 0.296648f, 0.296648f, 0.296648f, 0.922f }; return (float*)a; }
