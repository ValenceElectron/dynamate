...
DrawableObject::DrawableObject(float *pos, float *vertices, int numberOfVertices) {
    ...
    positionVector = glm::vec3(pos[0], pos[1], pos[2]);
...
void DrawableObject::setShader(GLuint shader) { this->shader = shader; }
...
glm::vec3 DrawableObject::getPosition() { return positionVector; }
...
void DrawableObject::draw(double currentTime, glm::mat4 vMat, glm::mat4 pMat, GLuint vbo) {
    ...
    tMat = glm::translate(glm::mat4(1.0f), getPosition());
